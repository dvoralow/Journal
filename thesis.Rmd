...
Nra_gam = gam(Nra ~ s(Year, bs = "cs") +s(Month, bs = "cc", k=12)+s(depth_meter, bs = "cs"), data = net_red_mtc)
  par(mfrow = c(2,2)) 
  plot( Nra_gam,se=TRUE,col = "blue")
    ...
    Sco_gam = gam(Sco ~ s(Year, bs = "cs") +s(Month, bs = "cc", k=12)+s(depth_meter, bs = "cs"), data = net_red_mtc)
  par(mfrow = c(2,2)) 
 ...
 Umo_gam = gam(Umo ~ s(Year, bs = "cs") +s(Month, bs = "cc", k=12)+s(depth_meter, bs = "cs"), data = net_red_mtc)
  par(mfrow = c(2,2)) 
...
#the abundance Mediter species model "MUL" "BAT" "Bbo" "Mme" "WHT"
 ...
 MUL_model = gam(MUL ~ s(Year, bs = "cs") +s(Month, bs = "cc", k=12)+s(depth_meter, bs = "cs"), data = net_mediter_mtc)
  par(mfrow = c(2,2)) 
  plot( MUL_model,se=TRUE,col = "blue")
    title(paste( mediter_table[which(rownames(mediter_table)=="MUL"),2],"T pref =",mediter_table[which(rownames(mediter_table)=="MUL"),3],sep = " "),line = -2, outer=TRUE)
     ...
     BAT_model = gam(BAT ~ s(Year, bs = "cs") +s(Month, bs = "cc", k=12)+s(depth_meter, bs = "cs"), data = net_mediter_mtc)
  par(mfrow = c(2,2)) 
  plot( BAT_model,se=TRUE,col = "blue")
    title(paste( mediter_table[which(rownames(mediter_table)=="BAT"),2],"T pref =",mediter_table[which(rownames(mediter_table)=="BAT"),3],sep = " "),line = -2, outer=TRUE)
     ...
     Bbo_model = gam(Bbo ~ s(Year, bs = "cs") +s(Month, bs = "cc", k=12)+s(depth_meter, bs = "cs"), data = net_mediter_mtc)
  par(mfrow = c(2,2)) 
  plot( Bbo_model,se=TRUE,col = "blue")
    title(paste( mediter_table[which(rownames(mediter_table)=="Bbo"),2],"T pref =",mediter_table[which(rownames(mediter_table)=="Bbo"),3],sep = " "),line = -2, outer=TRUE)
     ...
     Mme_model = gam(Mme ~ s(Year, bs = "cs") +s(Month, bs = "cc", k=12)+s(depth_meter, bs = "cs"), data = net_mediter_mtc)
  par(mfrow = c(2,2)) 
  plot( Mme_model,se=TRUE,col = "blue")
    title(paste( mediter_table[which(rownames(mediter_table)=="Mme"),2],"T pref =",mediter_table[which(rownames(mediter_table)=="Mme"),3],sep = " "),line = -2, outer=TRUE)
     ...
     WHT_model = gam(WHT ~ s(Year, bs = "cs") +s(Month, bs = "cc", k=12)+s(depth_meter, bs = "cs"), data = net_mediter_mtc)
  par(mfrow = c(2,2)) 
...
#the non abundance Mediter species model - high Tpref - Sd, EPI, Bca, Lmo
    ...
    Sd_model = gam(Sd ~ s(Year, bs = "cs") +s(Month, bs = "cc", k=12)+s(depth_meter, bs = "cs"), data = net_mediter_mtc)
  par(mfrow = c(2,2)) 
  plot( Sd_model,se=TRUE,col = "blue")
    ...
    EPI_model = gam(EPI ~ s(Year, bs = "cs") +s(Month, bs = "cc", k=12)+s(depth_meter, bs = "cs"), data = net_mediter_mtc)
  par(mfrow = c(2,2)) 
  plot( EPI_model,se=TRUE,col = "blue")
    ...
    Bca_model = gam(Bca ~ s(Year, bs = "cs") +s(Month, bs = "cc", k=12)+s(depth_meter, bs = "cs"), data = net_mediter_mtc)
  par(mfrow = c(2,2)) 
  plot( Bca_model,se=TRUE,col = "blue")
    ...
    Lmo_model = gam(Lmo ~ s(Year, bs = "cs") +s(Month, bs = "cc", k=12)+s(depth_meter, bs = "cs"), data = net_mediter_mtc)
  par(mfrow = c(2,2)) 
