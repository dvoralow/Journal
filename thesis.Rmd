...
#--loop - create graphs for the whole species
...
#upload require datasets, and replace the dipoldus, Marmir, pijama (Lmo, WHT, DIP, Dce) speciseis with DLS - all of them together
```{r}
