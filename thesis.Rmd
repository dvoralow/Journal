...
EPI_d = as.data.frame(EPI_d)
   ...
   EPI_gam = gam(EPI_d[,4] ~ te(Month, bs = "cc", k=12) + te(Year, bs = "tp", k=27)  + ti(Month,Year, bs = c("cc","tp"), k=c(12,27))+s(Depth) ,data = EPI_d, family = tw, knots = list(Month = c(0.5, 12.5)),select = TRUE)
 ...
 print(plot(EPI_gam) + labs(title = "EPI", pages = 1))
