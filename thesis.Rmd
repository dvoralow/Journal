...
all_dataF = read.csv(file = "prosseced data/all_data_fishes_only.csv", stringsAsFactors = F)
 ...
 scientific_namesF = scientific_namesF %>% dplyr:: filter(Sp_code != "BOX") %>% dplyr::filter(Sp_code != "FIS")
 
 # set NA to FALSE and remove rows with gamberi nets, and the columns "fish (FIS)", "general box (BOX)"
  all_dataF = all_dataF %>% replace_na(list(Gambari_net=FALSE)) %>% dplyr::filter(Gambari_net=="FALSE") %>% dplyr::select( everything(),-BOX, -FIS)
...
Aal_gam = gam(Aal ~ te(Month, bs = "cc", k=12) + te(Year, bs = "cr")  + ti(Month,Year, bs = c("cc","cr"))+s(depth_meter), select = T ,data = all_dataF)

Aal_gam = getViz(Aal_gam)

p = plot(Aal_gam, allTerms = T)
print(p,pages = 1, ask = FALSE)
...
#--Arg---
Arg_gam = gam(Arg ~ te(Month, bs = "cc", k=12) + te(Year, bs = "cr")  + ti(Month,Year, bs = c("cc","cr"))+s(depth_meter), select = T ,data = all_dataF)

Arg_gam = getViz(Arg_gam)

p = plot(Arg_gam, allTerms = T)
print(p,pages = 1, ask = FALSE)
...
#--BAT---
BAT_gam = gam(BAT ~ te(Month, bs = "cc", k=12) + te(Year, bs = "cr")  + ti(Month,Year, bs = c("cc","cr"))+s(depth_meter), select = T ,data = all_dataF)

BAT_gam = getViz(BAT_gam)

p = plot(BAT_gam, allTerms = T)
print(p,pages = 1, ask = FALSE)

#--Bbo---
Bbo_gam = gam(Bbo ~ te(Month, bs = "cc", k=12) + te(Year, bs = "cr")  + ti(Month,Year, bs = c("cc","cr"))+s(depth_meter), select = T ,data = all_dataF)

Bbo_gam = getViz(Bbo_gam)

p = plot(Bbo_gam, allTerms = T)
print(p,pages = 1, ask = FALSE)

#--Bca---
Bca_gam = gam(Bca ~ te(Month, bs = "cc", k=12) + te(Year, bs = "cr")  + ti(Month,Year, bs = c("cc","cr"))+s(depth_meter), select = T ,data = all_dataF)

Bca_gam = getViz(Bca_gam)

p = plot(Bca_gam, allTerms = T)
print(p,pages = 1, ask = FALSE)
      
      
#--Ccr---
Ccr_gam = gam(Ccr ~ te(Month, bs = "cc", k=12) + te(Year, bs = "cr")+ ti(Month,Year, bs = c("cc","cr"))+s(depth_meter), select = T ,data = all_dataF)

Ccr_gam = getViz(Ccr_gam)

p = plot(Ccr_gam, allTerms = T)
print(p,pages = 1, ask = FALSE)

#--Dce---
Dce_gam = gam(Dce ~ te(Month, bs = "cc", k=12) + te(Year, bs = "cr")  + ti(Month,Year, bs = c("cc","cr"))+s(depth_meter), select = T ,data = all_dataF)

Dce_gam = getViz(Dce_gam)

p = plot(Dce_gam, allTerms = T)
print(p,pages = 1, ask = FALSE)

#--DIP---
DIP_gam = gam(DIP ~ te(Month, bs = "cc", k=12) + te(Year, bs = "cr")  + ti(Month,Year, bs = c("cc","cr"))+s(depth_meter), select = T ,data = all_dataF)

DIP_gam = getViz(DIP_gam)

p = plot(DIP_gam, allTerms = T)
print(p,pages = 1, ask = FALSE)


#--Eer---
Eer_gam = gam(Eer ~ te(Month, bs = "cc", k=12) + te(Year, bs = "cr")  + ti(Month,Year, bs = c("cc","cr"))+s(depth_meter), select = T ,data = all_dataF)

Eer_gam = getViz(Eer_gam)

p = plot(Eer_gam, allTerms = T)
print(p,pages = 1, ask = FALSE)

#--Eha---
Eha_gam = gam(Eha ~ te(Month, bs = "cc", k=12) + te(Year, bs = "cr")  + ti(Month,Year, bs = c("cc","cr"))+s(depth_meter), select = T ,data = all_dataF)

Eha_gam = getViz(Eha_gam)

p = plot(Eha_gam, allTerms = T)
print(p,pages = 1, ask = FALSE)

#--EPI---
EPI_gam = gam(EPI ~ te(Month, bs = "cc", k=12) + te(Year, bs = "cr")  + ti(Month,Year, bs = c("cc","cr"))+s(depth_meter), select = T ,data = all_dataF)

EPI_gam = getViz(EPI_gam)

p = plot(EPI_gam, allTerms = T)
print(p,pages = 1, ask = FALSE)


#--Lbu---
Lbu_gam = gam(Lbu ~ te(Month, bs = "cc", k=12) + te(Year, bs = "cr")  + ti(Month,Year, bs = c("cc","cr"))+s(depth_meter), select = T ,data = all_dataF)

Lbu_gam = getViz(Lbu_gam)

p = plot(Lbu_gam, allTerms = T)
print(p,pages = 1, ask = FALSE)

#--Lmo---
Lmo_gam = gam(Lmo ~ te(Month, bs = "cc", k=12) + te(Year, bs = "cr")  + ti(Month,Year, bs = c("cc","cr"))+s(depth_meter), select = T ,data = all_dataF)

Lmo_gam = getViz(Lmo_gam)

p = plot(Lmo_gam, allTerms = T)
print(p,pages = 1, ask = FALSE)

#--Mce---
Mce_gam = gam(Mce ~ te(Month, bs = "cc", k=12) + te(Year, bs = "cr")  + ti(Month,Year, bs = c("cc","cr"))+s(depth_meter), select = T ,data = all_dataF)

Mce_gam = getViz(Mce_gam)

p = plot(Mce_gam, allTerms = T)
print(p,pages = 1, ask = FALSE)


#--Mme---
Mme_gam = gam(Mme ~ te(Month, bs = "cc", k=12) + te(Year, bs = "cr")  + ti(Month,Year, bs = c("cc","cr"))+s(depth_meter), select = T ,data = all_dataF)

Mme_gam = getViz(Mme_gam)

p = plot(Mme_gam, allTerms = T)
print(p,pages = 1, ask = FALSE)

#--MUL---
MUL_gam = gam(MUL ~ te(Month, bs = "cc", k=12) + te(Year, bs = "cr")  + ti(Month,Year, bs = c("cc","cr"))+s(depth_meter), select = T ,data = all_dataF)

MUL_gam = getViz(MUL_gam)

p = plot(MUL_gam, allTerms = T)
print(p,pages = 1, ask = FALSE)

#--MUL_UP---
MUL_UP_gam = gam(MUL_UP ~ te(Month, bs = "cc", k=12) + te(Year, bs = "cr")  + ti(Month,Year, bs = c("cc","cr"))+s(depth_meter), select = T ,data = all_dataF)

MUL_UP_gam = getViz(MUL_UP_gam)

p = plot(MUL_UP_gam, allTerms = T)
print(p,pages = 1, ask = FALSE)


#--Nra---
Nra_gam = gam(Nra ~ te(Month, bs = "cc", k=12) + te(Year, bs = "cr")  + ti(Month,Year, bs = c("cc","cr"))+s(depth_meter), select = T ,data = all_dataF)

Nra_gam = getViz(Nra_gam)

p = plot(Nra_gam, allTerms = T)
print(p,pages = 1, ask = FALSE)

#--Pca---
Pca_gam = gam(Pca ~ te(Month, bs = "cc", k=12) + te(Year, bs = "cr")  + ti(Month,Year, bs = c("cc","cr"))+s(depth_meter), select = T ,data = all_dataF)

Pca_gam = getViz(Pca_gam)

p = plot(Pca_gam, allTerms = T)
print(p,pages = 1, ask = FALSE)

#--Per---
Per_gam = gam(Per ~ te(Month, bs = "cc", k=12) + te(Year, bs = "cr")  + ti(Month,Year, bs = c("cc","cr"))+s(depth_meter), select = T ,data = all_dataF)

Per_gam = getViz(Per_gam)

p = plot(Per_gam, allTerms = T)
print(p,pages = 1, ask = FALSE)
