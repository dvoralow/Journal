...
par(mfrow = c(2,2)) 
  ...
  #clear memory
  gc()
  mediter_gam_season = gam(mtc ~ s(Year, bs = "cr") + s(loc_DEPTH, bs = "ad") +s(Date, bs = "gp") + s(Season, bs = "cc", k=4) ,data = net_mediter_mtc)
red_gam_season = gam(mtc ~ s(Year, bs = "cr") + s(loc_DEPTH, bs = "ad")+s(Date, bs = "gp") + s(Season, bs = "cc", k=4) ,data = net_red_mtc)
...
par(mfrow = c(2,2)) 
  ...
  #---month model
  mediter_gam_month = gam(mtc ~ s(Year, bs = "cr") + s(loc_DEPTH, bs = "ad") +s(Date, bs = "gp") + s(Month, bs = "cc", k=12) ,data = net_mediter_mtc)
red_gam_month = gam(mtc ~ s(Year, bs = "cr") + s(loc_DEPTH, bs = "ad")+s(Date, bs = "gp") + s(Month, bs = "cc", k=12) ,data = net_red_mtc)
